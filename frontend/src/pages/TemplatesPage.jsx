...
const DEFAULT_TEMPLATES = [
  { id: 'tpl-1', icon: '🏢', name: 'Earthquake Alert', category: 'emergency', urgency: 'critical', message: 'A major earthquake of magnitude [MAGNITUDE] has occurred near [ZONE]. Strong aftershocks are expected. If indoors, drop, cover, and hold under sturdy furniture. If outdoors, move away from buildings, power lines, and trees. Do not use elevators.' },
  { id: 'tpl-2', icon: '🌊', name: 'Flood Evacuation', category: 'emergency', urgency: 'critical', message: 'A severe flood warning has been issued for [ZONE]. All residents in low-lying areas must evacuate immediately to the nearest relief camp. Carry essential documents, medicines, and 3 days of food supply. Do not attempt to cross flooded roads.' },
  { id: 'tpl-3', icon: '☀️', name: 'Heatwave Advisory', category: 'health', urgency: 'high', message: 'An extreme heatwave warning is active for [ZONE] with temperatures expected to exceed [TEMP]°C. Avoid outdoor activity between 11:00 AM and 4:00 PM. Drink plenty of water. Keep vulnerable individuals, children, and pets indoors.' },
  { id: 'tpl-4', icon: '☣️', name: 'Gas Leak Warning', category: 'emergency', urgency: 'critical', message: 'A hazardous gas leak has been reported at [ZONE]. Residents are urged to shelter-in-place immediately. Close all doors, windows, and ventilation inlets. Seal doors with wet towels. Evacuate only if directed by emergency responders.' },
  { id: 'tpl-5', icon: '🔥', name: 'Fire Hazard Alert', category: 'emergency', urgency: 'critical', message: 'A major fire has been reported in [ZONE]. Residents are advised to evacuate the area immediately. Keep windows and doors closed. Avoid the area and allow emergency services to operate. Fire brigade and emergency teams are on the way.' }
];
